...
![Версия](https://img.shields.io/badge/версия-6.11-brightgreen)
...
- Drisnya mode: частицы лопаются с локальным pop-звуком, брызгами и combo-анимацией; prank-звук в новом звонке срабатывает один раз случайно через 5-120 секунд.
