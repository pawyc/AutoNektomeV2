...
![Версия](https://img.shields.io/badge/версия-6.14-brightgreen)
...
- Drisnya mode: частицы лопаются с локальным pop-звуком, не спавнятся под меню, ускоряются от серии кликов; фильтры пола/возраста остаются в дефолтном стиле NektoMe, а блок цветовой схемы скрывается.
